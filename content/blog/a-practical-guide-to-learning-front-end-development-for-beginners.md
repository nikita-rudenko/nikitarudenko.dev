...
You can complement your studies with a great guide on [Interneting Is Hard](https://internetingishard.com/).

Next, you are going to learn powerful layout techniques like CSS Flexbox and CSS Grid**.** Before moving on, complete this [short guide](http://learnlayout.com/) to get an overview of different layout techniques that people used before the Flexbox-Grid era. It’s unlikely that you will ever need to use them, but it’s always good to be aware and appreciate the technologies we have today.

## CSS Flexbox

I fell in love with Flexbox because of its simplicity and power. A lot of different properties may confuse you at first, so my suggestion is to put a cheat sheet near your computer so you can always easily look them up. Additionally, bookmark this interactive Flexbox [cheat sheet](https://yoksel.github.io/flex-cheatsheet/).

And finally, practice by playing the addictive [Flexbox Froggy ](https://flexboxfroggy.com/)game. 🐸

## CSS Grid

The Grid is more advanced and flexible but in most cases, Flexbox is quite enough. Anyway, you will have another powerful tool in your arsenal. Especially, if it’s that easy to understand when you grow your crops in [Grid Garden](https://cssgridgarden.com/). 🥕

## Practice

Before moving on to the final projects, I recommend you to do this:

1. Create an account on [Codepen](https://codepen.io/)**.** It’s a cool playground for the front end where you can build your projects, test your snippets, and practice.
2. Install a code editor on your machine and learn how to work with it.
3. Learn the basics of the command line from [this video ](https://www.youtube.com/watch?v=DP218aBHm1Q)by Wes Bos or the [Shell Workshop](https://classroom.udacity.com/courses/ud206) on Udacity.
4. Learn how to use Git in this [playlist](https://www.youtube.com/playlist?list=PL4cUxeGkcC9goXbgTDQ0n_4TBzOO0ocPR) by NetNinja.
5. Get some guided practice. Choose any projects from [this playlist](https://www.youtube.com/playlist?list=PLillGF-RfqbZTASqIqdvm1R5mLrQq79CU) by Traversy Media and code along. Build them until you feel confident. It would be great if you already use a code editor and version control, and upload your work to a special study repo on Github.
...
freeCodeCamp’s JavaScript section is great but I highly advise you to look at j[avascript.info ](https://javascript.info/)as an additional reference. This is the best resource that provides comprehensive information for everything related to JavaScript.

## More recommendations

1. [JavaScript Basics Course](https://www.youtube.com/playlist?list=PLWKjhJtqVAbk2qRZtWSzCIN38JC_NdhW5) by Beau Carnes, if you prefer visual guides.
2. Regarding the new standard for JavaScript, my favorites are the great courses [ES6 for everyone!](https://es6.io/) (paid) by Wes Bos and [Modern JavaScript](https://scrimba.com/g/ges6) by Beau Carnes.
3. [Regular expressions](https://scrimba.com/g/gregularexpressions) course on Scrimba.
4. [Object-Oriented JavaScript](https://www.youtube.com/watch?v=4l3bTDlT6ZI&list=PL4cUxeGkcC9i5yvDkJgt60vNVWffpblB7) course by NetNinja was very helpful to me.
...
As a little help, I advise you to watch [JavaScript Cardio Sessions](https://www.youtube.com/playlist?list=PLillGF-Rfqbb4ZOnsNCIB-DnLuUrQjS_G) by Traversy Media.

For more practice, I highly recommend you to sign up on [CodeWars](https://www.codewars.com/) and set an initial goal to achieve **6kyu**. It’s very helpful because when you complete any challenge, you can look through other people’s solutions and discover new tricks, approaches, and ideas.
...
Now it’s time to take the [Javascript30](https://javascript30.com/) challenge by Wes Bos. This is the best way to learn how HTML, CSS, and JavaScript work together, polish your knowledge of fundamentals, and understand the DOM. Building these little projects was a great experience and really fun for me!
...
1. [Complete React Tutorial (with Redux) ](https://www.youtube.com/playlist?list=PL4cUxeGkcC9ij8CfkAY2RAGb-tmkNwQHG)by NetNinja
...
6. Get a taste of advanced web design from this [Web Design for Web Developers ](https://www.udemy.com/web-design-secrets/)course.
