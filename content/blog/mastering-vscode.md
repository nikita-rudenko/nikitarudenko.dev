...
---
VSCode is an ultimate multi-purpose code editor that can fit in any workflow. It has a lot of hidden features and a huge variety of extensions that can take your work experience to a new level. It’s hard to find and keep track of everything, so in this post I will share my experience. The guide is a bit JavaScript/TypeScript centric, however, I believe everyone can pick up something new.
